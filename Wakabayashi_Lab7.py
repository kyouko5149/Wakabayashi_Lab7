...
if (40 <= prelim_grade <= 100) or (40 <= midterm_grade <= 100) or (40 <= finals_grade <= 100):
    if sumgrade <= 74 and sumgrade >= 40:
        ...
        print(f"Greetings {name} from {section}! Your Final Grade is {sumgrade} and Your GPA: 2.50")
    elif sumgrade >= 84 and sumgrade <= 86:
        print(f"Greetings {name} from {section}! Your Final Grade is {sumgrade} and Your GPA: 2.25")
    elif sumgrade >= 87 and sumgrade <= 89:
        print(f"Greetings {name} from {section}! Your Final Grade is {sumgrade} and Your GPA: 2.00")
    elif sumgrade >= 90 and sumgrade <= 92:
        print(f"Greetings {name} from {section}! Your Final Grade is {sumgrade} and Your GPA: 1.75")
    elif sumgrade >= 93 and sumgrade <= 95:
        print(f"Greetings {name} from {section}! Your Final Grade is {sumgrade} and Your GPA: 1.50")
    elif sumgrade >= 96 and sumgrade <= 98:
        print(f"Greetings {name} from {section}! Your Final Grade is {sumgrade} and Your GPA: 1.25")
    elif sumgrade >= 99 and sumgrade <= 100:
        print(f"Greetings {name} from {section}! Your Final Grade is {sumgrade} and Your GPA: 1.00")
else:
    print("Invalid grade")
